      ...
      <>
               ...
               posts.map((post) => {
                  return (
                     <PostCard
                        ...
                        author={post.author}
                        image={appwriteDatabase.getFilePreview(
                           post.featureImage
                        )}
         ...
         <div className={`flex justify-center items-center gap-2 my-4`}>
            <Button
               ...
               disabled={page == 0}
               className={` text-white bg-black rounded-md max-sm:text-xs max-sm:px-3 max-sm:py-2 px-4 py-2  ${
                  page == 0 && 'bg-gray-700'
               }`}
            >
               Prev Post
