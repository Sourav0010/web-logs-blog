...
function ToggleItem({ question, answer, id, sk, index, length }) {
   if (index == length - 1) {
      return (
         <div>
            <h2 id='accordion-collapse-heading-3'>
               <button
                  ...
                  onClick={() => {
                     document
                        .getElementById(`accordion-collapse-body-1 ${id}`)
            ...
            <div
               id={`accordion-collapse-body-1 ${id}`}
               className='hidden'
            ...
            <div>
               <h2 id='accordion-collapse-heading-1'>
                  <button
                     ...
                     onClick={() => {
                        document
                           .getElementById(`accordion-collapse-body-2 ${id}`)
                           .classList.toggle('hidden');
                        document
                           .getElementById(sk)
                           .classList.toggle('rotate-180');
               ...
               <div
                  id={`accordion-collapse-body-2 ${id}`}
                  className='hidden'
